...
function(yotta_apply_target_rules target_type target_name)
    if(${target_type} STREQUAL "EXECUTABLE")
        add_custom_command(TARGET ${target_name}
            ...
            COMMAND ../../HelloWorld/yotta_targets/bbc-microbit-classic-gcc/CMake/srec_cat ${NRF51822_BOOTLOADER_HEX_FILE} -intel ${NRF51822_SOFTDEVICE_HEX_FILE} -intel ${target_name}.hex -intel -o ${target_name}-combined.hex -intel --line-length=44
